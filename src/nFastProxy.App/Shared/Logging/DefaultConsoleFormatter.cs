...
internal sealed class DefaultConsoleFormatter : ConsoleFormatter, IDisposable
{
        ...
        TextWriter textWriter)
    {
        ...
        logText.AppendFormat("{0}{1}", DefaultForegroundColor, time);
        logText.AppendFormat("{0}{1} ", GetLogLevelColor(logEntry.LogLevel), GetLevelName(logEntry.LogLevel));
        logText.AppendFormat("{0}[{1}] ", GetForegroundColorEscapeCode(ConsoleColor.Gray), logEntry.Category);
        logText.AppendFormat("{0}{1}", DefaultForegroundColor, message);
